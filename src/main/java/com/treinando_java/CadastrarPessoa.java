...
public class CadastrarPessoa {
    ...
    //comportamento de um objeto
      public CadastrarPessoa (int idade, String nome, String nacionalidade, String natural, String profissao,
                     String time, String sexo, String logradouro, int numeroLogradouro ) {
   ...
   // método principal
    public static void main(String [] args) {
      ...
      CadastrarPessoa alexandre = new CadastrarPessoa(31, "Alexandre","Brasileiro","São Paulo", "QA", "Palmeiras", "M", "Rua a direita", 88);
      CadastrarPessoa joao = new CadastrarPessoa(25, "João","Brasileiro","São Paulo", "Dev", "Corinthians", "M", "Rua a esquerda", 1);
      CadastrarPessoa ana = new CadastrarPessoa(40, "Ana","Brasileiro","São Paulo", "PO", "São Paulo", "F", "Rua no centro", 5);
