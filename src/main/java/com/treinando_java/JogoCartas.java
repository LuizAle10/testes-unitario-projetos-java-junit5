...
public class JogoCartas {
    ...
    /*
    método shuffle() da classe Collections. Ele recebe uma lista como parâmetro. Como você tem um array, utilize o Arrays.asList() para converter o array em lista.
